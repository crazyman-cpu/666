...
<head>
	...
	<style type="text/css">
		...
		.pointerDiv .active,
		.pointerDiv a:hover{
			background:url(images/pointer_active.png) no-repeat;
		}
		.content{
			width: 940px;
			margin: 0 auto;
...
<body>
	...
	<div class="footer">
		<div class="w">
			...
			<p>Site Powered by Wordpress. Design and Developed by VIVROCKS.
			</p>
			<p><a href="">Home</a><a href="">About</a><a href="">Products</a><a href="">Services</a><a href="">Contact
</a></p>
